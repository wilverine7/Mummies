...
{
    public partial class Mummies_databaseContext : DbContext
    {
        public Mummies_databaseContext()
        {
        }

        public Mummies_databaseContext(DbContextOptions<Mummies_databaseContext> options)
            : base(options)
        {
        }
